...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const body = reactive({ titulo: "", ISSN: "", descripcion: "", year: "", url: "", miembrosColaboradores: [], visible: true, tipo: "" });
