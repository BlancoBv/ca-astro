...
import { useSSRContext, defineComponent, useTemplateRef, ref, onMounted, onUnmounted, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createElementBlock, mergeProps, createElementVNode, renderSlot, createBlock, resolveDynamicComponent, createCommentVNode, resolveComponent, resolveDirective, Fragment, renderList, normalizeClass, Transition, normalizeProps, createSlots, withDirectives, reactive } from 'vue';
import { a as useGetData, u as useSendData } from '../../chunks/http_BqZswbFI.mjs';
import { v as validateBuilder } from '../../chunks/zodValidations_Cp4OsDPW.mjs';
import { a as script$4, s as script$5, g as script$7, c as script$8, U as UniqueComponentId, Z as ZIndex, O as OverlayEventBus, C as ConnectedOverlayScrollHandler, R as Ripple, f as script$9, h as script$a, i as script$b, d as script$c, j as script$d, k as script$e, l as script$f, m as script$g, n as script$h, o as script$i, p as script$j } from '../../chunks/index_BdxrLm6J.mjs';
import { s as script$6 } from '../../chunks/index_CDSKIpyG.mjs';
import { f as formatDate, b as formatMoneda } from '../../chunks/format_DDvzIGDn.mjs';
import { ssrInterpolate, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList } from 'vue/server-renderer';
/* empty css                                    */
import { _ as _export_sfc } from '../../chunks/_plugin-vue_export-helper_CbFQKVlu.mjs';
import { B as BaseStyle, A as resolveFieldData, C as focus, F as isPrintableCharacter, G as getFirstFocusableElement, H as getLastFocusableElement, N as equals, I as addStyle, J as relativePosition, u as getOuterWidth, K as absolutePosition, L as isTouchDevice, M as getFocusableElements, b as isNotEmpty, O as findLastIndex, f as findSingle, Q as FilterService, i as isEmpty } from '../../chunks/_@astro-renderers_Ciejw6DY.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { data, isPending, refetch, noMiembrosColab, miembros, miembrosIsPending, addProyecto, body, validator, handleSubmit, ListaProyectos, get MultiSelect() {
      return script;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
