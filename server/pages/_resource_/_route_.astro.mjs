/* empty css                                      */
import { b as createAstro, c as createComponent, r as renderTemplate, a as renderComponent, m as maybeRenderHead, u as unescapeHTML } from '../../chunks/astro/server_PUIICibt.mjs';
...
const $$route = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const content = await fetch(`${origin}/api/articulos?ruta=${resource}/${route}`).then(
    (res) => res.json()
  );
  if (!content) {
