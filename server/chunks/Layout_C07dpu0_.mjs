import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, d as addAttribute, a as renderComponent, ac as Fragment, e as renderTransition, ad as createTransitionScope, ae as renderHead, af as renderSlot, ag as renderScript } from './astro/server_DmhofpIV.mjs';
...
const $$NavBarServer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav class="navbar bg-base-200/80 backdrop-blur-sm min-h-20 w-full z-40 sticky top-0" data-astro-transition-persist="navbar"${addAttribute(renderTransition($$result, "kg4xebrk", "", "navbar"), "data-astro-transition-scope")}> <div class="flex-none lg:hidden"> <label for="my-drawer-3" aria-label="open sidebar" class="btn btn-square btn-ghost size-10"> <i class="bi bi-list text-3xl"></i> </label> </div> <div class="navbar-start grow justify-center lg:justify-start lg:grow-0"> <a href="/" class="btn btn-ghost" title="Inicio"> ${renderComponent($$result, "Image", $$Image, { "src": "/logo.webp", "alt": "logo", "class": "h-full object-contain", "width": 100, "height": 300, "loading": "eager" })} </a> </div> <div class="navbar-center hidden lg:flex"> ${renderComponent($$result, "NavBarItems", $$NavBarItems, {})} <div class="dropdown dropdown-hover group"> <div tabindex="0" role="button" class="rounded-btn hover:bg-base-content/10 py-2 px-4 text-sm mb-1 flex gap-1">
Documentos
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es" data-theme="winter"> <head><meta charset="UTF-8"><meta name="description" content="Cuerpo academico de cómputo distribuido del Instituto Tecnologico Superior de los Ríos"><meta name="viewport" content="width=device-width"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/site.webmanifest"><meta name="generator"${addAttribute(Astro2.generator, "content")}>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}<title>${title}</title>${renderHead()}</head> <body class="w-screen h-screen drawer overflow-x-clip"> <input id="my-drawer-3" type="checkbox" class="drawer-toggle"> <div class="drawer-content h-full w-full" id="scroll-container"> ${renderComponent($$result, "Header", $$Header, {})} ${renderComponent($$result, "NavBarServer", $$NavBarServer, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})} </div> <div class="drawer-side z-50"> <label for="my-drawer-3" aria-label="close sidebar" class="drawer-overlay"></label> ${renderComponent($$result, "SideBar", $$SideBar, {})} </div>  ${renderScript($$result, "/home/blanco/Documentos/ca-astro/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")}</body></html>`;
