import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, d as addAttribute, a as renderComponent, F as Fragment, e as renderTransition, f as renderHead, g as renderSlot, h as createTransitionScope, p as renderScript } from './astro/server_DqkNLIlm.mjs';
import { a as useGetData, _ as _export_sfc, $ as $$ClientRouter } from './_plugin-vue_export-helper_CeNPFBqF.mjs';
...
const MiembrosSide = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
...
const ColaboradoresSide = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]);
...
const SideBarItems = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
...
const $$MiembrosNav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="dropdown dropdown-hover group"> <div tabindex="0" role="button" class="rounded-btn hover:bg-base-content/10 py-2 px-4 text-sm mb-1 flex gap-1"> ${colaboradores ? "Colaboradores" : "Miembros"} <div class="swap swap-rotate group-hover:swap-active"> <i class="bi bi-caret-down-fill swap-off"></i> <i class="bi bi-caret-up-fill swap-on"></i> </div> </div> <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-60 p-2 shadow"> ${res.response?.map((miembro) => {
    return renderTemplate`<li v-if="!isPending" v-for="miembro in data.response"> <a${addAttribute(`/miembros/${miembro.idmiembro}`, "href")} class="text-balance"> ${miembro.nombreCompleto} </a> </li>`;
  })} </ul> </div>`;
