...
const YoutubeLinks = sequelize.define("youtubeLinks", {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
export { Articulo as A, Banners as B, Contactos as C, Etiquetas as E, Logs as L, Menus as M, Proyectos as P, Roles as R, Submenus as S, Users as U, YoutubeLinks as Y, EtiquetasArticulos as a, Blog as b, EtiquetasBlogs as c, Miembros as d, Publicaciones as e, Permisos as f, ProyectosMiembros as g, PublicacionesMiembros as h, sequelize as s };
