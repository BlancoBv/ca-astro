import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, d as addAttribute, a as renderComponent, ad as Fragment, e as renderTransition, h as createTransitionScope, f as renderHead, g as renderSlot, ae as renderScript } from './astro/server_CYDDhvI_.mjs';
import { _ as _export_sfc, $ as $$ClientRouter } from './_plugin-vue_export-helper_VlCHcN7j.mjs';
...
const $$SideBar = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$SideBar;
  const { user } = Astro2.locals;
  return renderTemplate`${maybeRenderHead()}<ul class="menu bg-base-200 min-h-full w-80 p-4"${addAttribute(createTransitionScope($$result, "ebud5mhz"), "data-astro-transition-persist")}> ${renderComponent($$result, "SidebarItems", $$SidebarItems, {})} <li><a href="/login"> ${user?.id ? "Ir al panel" : "Iniciar sesi\xF3n"} </a></li> </ul>`;
